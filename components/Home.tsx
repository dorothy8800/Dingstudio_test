...
import { SiteConfig, PortfolioItem, ServiceItem } from '../types';
...
export const Home: React.FC<HomeProps> = ({ config, portfolioItems }) => {
  // Simple form state for the contact form
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-black">
        ...
        {/* Abstract Fluid Background Image with Parallax - Grayscale applied */}
        <div 
        ...
        {/* Interactive Spotlight Glow - Changed to White/Achromatic */}
        <div 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-gray-400 mb-8 text-lg">
                당신의 아이디어가 딩스튜디오를 만나면 현실이 됩니다.<br/>
                가벼운 문의라도 언제든 환영합니다.
              </p>
              ...
              <form onSubmit={handleContactSubmit} className="space-y-6">
                ...
                <button 
                  ...
                  className={`w-full py-4 rounded-xl font-bold text-white transition-all flex items-center justify-center gap-2 ${
                    formStatus === 'success' ? 'bg-green-600' : 'hover:opacity-90'
                  }`}
                ...
                >
                  {formStatus === 'submitting' ? (
                    ...
                    <>
                      <Icons.CheckCircle size={20} /> 전송 완료
                    </>
                  ) : (
                    '문의 보내기'
                  )}
